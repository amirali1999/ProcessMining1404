...
api_urlpatterns = [
    ...
    path('discovered-models/<int:pk>/cytoscape-data/', views.DiscoveredModelViewSet.as_view({'get': 'petrinet_cytoscape_json_view'}), name='discovered-model-petrinet-cytoscape-data'),
    path('discovered-models/<int:pk>/dataframe-stats/', views.DiscoveredModelViewSet.as_view({'get': 'dataframe_stats_view'}), name='discovered-model-dataframe-stats'),
